...
public class ConnectivityStatePlusPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let instance = ConnectivityStatePlusPlugin(connectivityProvider: connectivityProvider)
